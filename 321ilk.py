...
import pandas as pd
data=pd.read_excel('ethanecp.xlsx',header=None,index_col=0,skiprows=1)
...
def standard_enthalpy_of_f(n, CO2, H2O, a):
    ...
    # all CO2, H2O, and a parameters mean its coefficient times the standard ethalpy of formation of that substance in gas molecule.
