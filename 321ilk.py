                    ...
                    if T0_a_K >= 0:
                        ...
                        if T0_air_K >= 0:
                            ...
                            if burned_alkane == "E":
                                ...
                                DH_air = MCPH(A_air, B_air, C_air, D_air, T0_air_K) * (T-T0_air_K)
                                
                                print("\nEnthalpy change of air with the change of temperature from", T0_air_C, "°C to 25 °C is:", DH_air, "J")
                                ...
                                print("\nA_ethane is:", A_ethane)
                                print("\nB_ethane is:", B_ethane)
                                print("\nC_ethane is:", C_ethane)
                                print("\nD_ethane is:", D_ethane)
                                
                                DH_ethane = MCPH(A_ethane, B_ethane, C_ethane, D_ethane, T_ethane) * (T-T_ethane)
                                
                                print("\nEnthalpy change of ethane with the change of temperature from", T0_a_C, "°C to 25 °C is:", DH_ethane, "J")
