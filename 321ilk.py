        ...
        if mole_of_alkane > 0:
            ...
            if 100 >= excess_air >= 0:
                ...
                if calculation_type == "T":
                    ...
                    T0_a_C = float(input("Please enter the initial temperature of the burned alkane(°C): "))
                    T0_a_K = T0_a_C + 273.15
                    
                    if T0_a_K >= 0:
                        
                        T0_air_C = float(input("Please enter the initial temperature of the air(°C): "))
                        ...
                        if T0_air_K >= 0:
                            ...
                            if burned_alkane == "E":
                                ...
                                print("\nEnthalpy change of air with the change of temperature from 40°C to 25°C is:", DH_air, "J")
                    ...
                    T0a = float(input("Please enter the initial temperature of the burned alkane(below 2000 K)(°C): "))

                    if 2000 > T0a >= 0:
                        
                        T0air = float(input("Please enter the initial temperature of the air(below 2000 K)(°C): "))
