        ...
        if mole_of_alkane > 0:
            ...
            if 100 >= excess_air >= 0:
                ...
                if calculation_type == "T":
                    ...
                    if T0_a_K >= 0:
                        ...
                        if T0_air_K >= 0:
                            ...
                            if burned_alkane == "E":
                                ...
                                print("The entropy change of air from ", T0_air_C," °C to 25°C is ", DS_air,"J/K.")
                                ...
                                print("The entropy change of ethane from ", T0_a_C," °C to 25°C is ", DS_ethane,"J/K.")
                                ...
                                print("The standard entropy change while the ethane is burning is ", DS298," J/K.")
                                
                                DS_product = mean_heat_capacity_S(A_p, B_p, C_p, D_p, T_ad, T) * math.log(T_ad/T)
                                
                                print("The entropy change of the products from ", T_C," °C to ", T_ad," is ", DS_ethane,"J/K.")
                                ...
                                print("The entropy change of methane from ", T0_a_C," °C to 25°C is ", DS_methane,"J/K.")
                                ...
                                print("The entropy change of the products from ", T_C," °C to ", T_ad," is ", DS_methane,"J/K.")
                    ...
                    T0_a_C = float(input("\nPlease enter the initial temperature of the burned alkane(below 2000 K)(°C): "))
                    T0_a_K = T0_a_C + 273.15

                    if 2000 > T0_a_K >= 0:
                        
                        T0_air_C = float(input("\nPlease enter the initial temperature of the air(below 2000 K)(°C): "))
                        T0_air_K = T0_air_C + 273.15
                        ...
                        if 2000 > T0_air_K >= 0:
                            ...
                            if burned_alkane == "E":
                                ...
                                print("The heat requirement for the products to reach a temperature of 2000 K for", mole_of_alkane,"moles of ethane at ", T0_a_C," °C burned with ", excess_air,"% excess air at ", T0_air_C," °C is ", DH,"J.")
                                ...
                                print("The entropy change of the products from ", T_C," °C to ", 2000," is ", DS_ethane,"J/K.")
                                ...
                                print("The heat requirement for the products to reach a temperature of 2000 K for", mole_of_alkane,"moles of methane at ", T0_a_C," °C burned with ", excess_air,"% excess air at ", T0_air_C," °C is ", DH,"J.")
                                ...
                                print("The entropy change of the products from ", T_C," °C to ", 2000," is ", DS_methane,"J/K.")
